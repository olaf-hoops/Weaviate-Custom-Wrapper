...
class Weaviate(VectorStore):
    ...
    def similarity_search(
        ...
        # Fetch schema of the class and extract property names
        class_schema = self._client.schema.get(self._index_name)
        properties = [prop["name"] for prop in class_schema["properties"]]

        query_obj = self._client.query.get(self._index_name, properties)
